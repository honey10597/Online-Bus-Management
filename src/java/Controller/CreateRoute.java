...
public class CreateRoute extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println(RouteNo+" "+Bus_Number+" "+Route_Name+" "+Driver_Name+" "+Contact_Number);
        
        rdao.enter(RouteNo,Bus_Number,Route_Name,Driver_Name,Contact_Number);
        
        response.sendRedirect("home_viewall.jsp");
//        if(chk == true)
//        {
//            out.println("<script>");
//            out.println("location = 'home_viewall.jsp';");
//            out.println("alert('Data successfully Regeistered');");
//            out.println("</script>");
//        }else
//        {
//            out.println("<script>");
